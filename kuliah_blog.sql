...
--
-- Host: localhost:3306
-- Generation Time: Oct 26, 2025 at 12:31 PM
...
(10, 15, NULL, 'the cat is on fire', '2025-10-24 20:12:41', 1),
(11, 10, NULL, 'wow now i know how to learn github', '2025-10-24 20:13:02', 1);
...
--
-- Table structure for table `user_deletes`
--
...
--
-- Dumping data for table `user_deletes`
--

INSERT INTO `user_deletes` (`id`, `admin_id`, `user_id`, `user_name`, `user_email`, `deleted_at`) VALUES
(1, 12, 9, 'Vanessa', 'vane@gmail.com', '2025-10-26 19:20:53'),
(2, 12, 10, 'Civago', 'civa@gmail.com', '2025-10-26 19:21:03');
...
--
-- Indexes for table `user_deletes`
--
ALTER TABLE `user_deletes`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `user_deletes`
--
ALTER TABLE `user_deletes`
